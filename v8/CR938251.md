...
- Report: Mar 5, 2019
- Fix: Mar 6, 2019
- Credit: glazunov of Google Project Zero
...
```
## Reference
[Issue](https://bugs.chromium.org/p/chromium/issues/detail?id=938251)
[Exploit](https://bugs.chromium.org/p/chromium/issues/detail?id=938251)